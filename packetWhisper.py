...
# 
# python3 modification: qui113x       (I left all of Joe's comments for posterity and clarity)
...
def ModeHelp():
    ...
    print("")
    print("FQDNs with random subdomains help prevent DNS caching, while also enabling")
    print("transferral of data beyond a NAT'd network device, since the sending")
...
def SelectAndGenerateRandomFQDNs( sourceFile, cloakedFile ):
    ...
    try:
        os.system( "python3 ciphers/subdomain_randomizer_scripts/%s %s" % ( scriptFilename, cloakedFile ))
...
def ExtractCapturedPayload():
    ...
    print("a chance it was saved in 'PCAP-like' format, which won't work")
